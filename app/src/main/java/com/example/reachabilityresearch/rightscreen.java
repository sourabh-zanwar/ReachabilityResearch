    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked Button 1\nAccelerometer Data :\nX :"+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnRight1 : Expected 3");
            }
        });
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked Button 3\nAccelerometer Data :\nX :"+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnRight1 : Expected 3");
            }
        });
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked Button 4\nAccelerometer Data :\nX :"+xco+" Y : "+yco+" Z : "+zco+time5);
                Log.d(TAG,"\nOnRight1 : Expected 6");
            }
        });
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked Button 6\nAccelerometer Data :\nX :"+xco+" Y : "+yco+" Z : "+zco+time6);
            }
        });
