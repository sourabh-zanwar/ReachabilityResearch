    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked 1 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnRight1 : Expected 3");
            }
        });
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked 3 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnRight1 : Expected 3");
            }
        });
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked 4 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time5);
                Log.d(TAG,"\nOnRight1 : Expected 6");
            }
        });
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight1 : Clicked 6 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time6);
            }
        });
