    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight2 : Clicked 5 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnRight2 : Expected 2");
            }
        });
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight2 : Clicked 2 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnRight2 : Expected 6");
            }
        });
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight2 : Clicked 6 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time5);
                Log.d(TAG,"\nOnRight2 : Expected 3");
            }
        });
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight2 : Clicked 3 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time6);
            }
        });
