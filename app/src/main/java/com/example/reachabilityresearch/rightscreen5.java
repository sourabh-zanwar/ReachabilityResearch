...
public class rightscreen5 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensorManager.registerListener( rightscreen5.this,accelerometer,SensorManager.SENSOR_DELAY_NORMAL);
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 4 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time1);
                Log.d(TAG,"\nOnRight6 : Expected 1");
            }
        });
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 1 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time2);
                Log.d(TAG,"\nOnRight6 : Expected 5");
            }
        });
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 5 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnRight6 : Expected 2");
            }
        });
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 2 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnRight6 : Expected 6");
            }
        });
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 6 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time5);
                Log.d(TAG,"\nOnRight6 : Expected 3");
            }
        });
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight6 : Clicked 3 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time6);
            }
        });
        ...
        end2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intente = new Intent(rightscreen5.this,screen5.class);
                startActivity(intente);
                Log.d(TAG, "OnRight6 : Clicked Button Next");
            }
        });
    }
    @Override
