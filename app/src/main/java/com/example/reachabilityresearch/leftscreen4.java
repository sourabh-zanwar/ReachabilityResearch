...
public class leftscreen4 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sensorManager.registerListener( leftscreen4.this,accelerometer,SensorManager.SENSOR_DELAY_NORMAL);
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 1 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time1);
                Log.d(TAG,"\nOnLeft5 : Expected 4");
            }
        });
        ...
        l2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 4 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time2);
                Log.d(TAG,"\nOnLeft5 : Expected 2");
            }
        });
        ...
        l3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 2 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnLeft5 Dominant Hand : Expected 5");
            }
        });
        ...
        l4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 5 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnLeft5 : Expected 3");
            }
        });
        ...
        l5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 3 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnLeft5 : Expected 6");
            }
        });
        ...
        l6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft5 : Clicked 6 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
            }
        });
        ...
        end1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenta = new Intent(leftscreen4.this,rightscreen4.class);
                startActivity(intenta);
                Log.d(TAG, "OnLeft5 : Clicked NEXT");
            }
        });
    }
    @Override
