    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 5 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time1);
                Log.d(TAG,"\nOnLeft2 : Expected 3");
            }
        });
        ...
        l2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 3 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time2);
                Log.d(TAG,"\nOnLeft2 : Expected 1");
            }
        });
        ...
        l3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 1 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnLeft2 Dominant Hand : Expected 6");
            }
        });
        ...
        l4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 6 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnLeft2 : Expected 2");
            }
        });
        ...
        l5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 2 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnLeft2 : Expected 4");
            }
        });
        ...
        l6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnLeft2 : Clicked 4 Accelerometer Data : X : "+xco+" Y : "+yco+" Z : "+zco+time4);
            }
        });
        ...
        end1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentd = new Intent(leftscreen1.this,rightscreen1.class);
                startActivity(intentd);
                Log.d(TAG, "OnLeft2 : Clicked NEXT");
            }
        });
    }
    @Override
