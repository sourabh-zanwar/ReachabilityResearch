    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 1 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time1);
                Log.d(TAG,"\nOnRight4 : Expected 4");
            }
        });
        ...
        r2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 4 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time2);
                Log.d(TAG,"\nOnRight4 : Expected 2");
            }
        });
        ...
        r3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 2 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time3);
                Log.d(TAG,"\nOnRight4 : Expected 5");
            }
        });
        ...
        r4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 5 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time4);
                Log.d(TAG,"\nOnRight4 : Expected 3");
            }
        });
        ...
        r5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 3 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time5);
                Log.d(TAG,"\nOnRight4 : Expected 6");
            }
        });
        ...
        r6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "OnRight4 : Clicked 6 Accelerometer Data : X :"+xco+" Y : "+yco+" Z : "+zco+time6);
            }
        });
